		...
		<div class="row-fluid">
			...
			<div class="span9">
				<div class="konten">
						...
						<div class="row-fluid">
							<div class="span8">
							<form action="proses_inputKategori.php" method="POST">
								<label>Id Kategori</label>
								<input type="text" placeholder="Id Kategori" class="input-xxlarge" name="id_kategori" >
								<label>Nama Kategori</label>
								<input type="text" placeholder="Nama Kategori" class="input-xxlarge" name="nm_kategori" >
								<br/>
