<?php
	...
	$id = $_GET['id'];
	$query = mysqli_query($kon, "SELECT * FROM isi_berita WHERE id_berita='$id'")or die (mysqli_error($kon));
				...
				<div class="konten">
						...
						<div class="row-fluid">
							...
							<form action="proses_editBerita.php" method="POST" enctype="multipart/form-data">
									...
									<input type="text"  name="id_berita" value="<?php echo $tampil['id_berita']; ?>" class="input-xxlarge"readonly>
									<label>Kategori</label>
									<select class="input-xxlarge" name="id_kategori" readonly>
										<option value="1"
										<?php
											if($tampil['id_kategori']=='1'){
									...
									<select>
									<label>Judul</label>
									<input type="text" value="<?php echo $tampil['judul']; ?>" class="input-xxlarge" name="judul" />
									<label>Tanggal</label>
									<input type="text" id="datepicker" value="<?php echo $tampil['tanggal']; ?>" name="tanggal" />
									<label>Foto</label>
									<input type="file" class="span5" value="<?php echo $tampil['gambar']; ?>" name="file_gambar" />
									<hr />
									<label>Deskripsi Berita</label>
									<textarea class="input-xxlarge" name="isi"><?php echo $tampil['isi']; ?></textarea><br/>
