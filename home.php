<div class="articles">	
	<?php
		...
		$tampil = mysqli_query($kon, "SELECT * FROM isi_berita");//query untuk menghitung total jumlah keseluruhan tabel 
	...
	<div align="center">
		<?php for($i=1; $i<=$semua_hal; $i++){?>
			<a href="index.php?menu=home&halaman=<?php echo $i ?>"> <?php echo $i; ?></a>
		<?php }?>
	</div>
</div>